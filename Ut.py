...
\033[0;93mUR D4D >  Saqii D'Lewixx               
\033[0;92mWP NO  >  03355879404
\033[0;94mYT          >  SAQII TECH
\033[0;91mLover     >  CHUZII '''
...
def yayanxd():
    ...
    try:
        ...
        print ' %s*%s WELCOME TO THE SAQII TOOL ENJOY FREE CLONING...'%(O,N);time.sleep(2)
...
def info_tools():
    ...
    print '\n %s[%s>%s] 𝐄𝐃𝐈𝐓𝐎𝐑༆   : Saqii D Lewixx .'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] 𝐆𝐈𝐓𝐇𝐔𝐁༆    :KU BATAO'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] 𝐖𝐡𝐚𝐭𝐒𝐀𝐏༆   : 03355879404'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] 𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 : Saqii D Lewixx '%(N,H,N);time.sleep(0.07)
